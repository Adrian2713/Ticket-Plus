...
public class FindPeak {
	...
	private static void printList(List<Map.Entry<String, Double>> timeList) {//向condole里面输出一个list
		for (Map.Entry<String, Double> entry : timeList) {
			System.out.println("time: " + entry.getKey() + " count: " + entry.getValue());
		}
	}

	private static List<LocalTime> initBuckets() {//时间粒度粗化，从0.00到23.45 切分
	...
	private static String findBucket(String currentTime) {//binary search 找到区间
